...
RESULTS_DIR = "results"
PRODUCT = "FubuJson"
COPYRIGHT = 'Copyright 2012 FubuJson. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuJson.sln', :clrversion => CLR_TOOLS_VERSION
